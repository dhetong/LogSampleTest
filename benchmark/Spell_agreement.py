...
tau = [0.95, 0.6, 0.75, 0.7, 0.5, 0.65, 0.55, 0.9, 0.8, 0.85]
n_para = 10
...
for index in range(0,Spark_num,1):
    ...
    for para_index in range(0,n_para-1,1):
        ...
        print(para_info)
        parser_1 = Spell.LogParser(log_format=setting['log_format'], indir=indir, outdir=output_dir_1, rex=setting['regex'], tau=tau[para_index])
        parser_2 = Spell.LogParser(log_format=setting['log_format'], indir=indir, outdir=output_dir_2, rex=setting['regex'], tau=tau[para_index])
